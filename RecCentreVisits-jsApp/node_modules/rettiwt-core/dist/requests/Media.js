...
exports.videoStream = exports.initializeUpload = exports.finalizeUpload = exports.appendUpload = void 0;
...
function videoStream(id) {
    return {
        method: 'get',
        url: "https://twitter.com/i/api/1.1/live_video_stream/status/".concat(id),
    };
}
