...
exports.unretweet = exports.unpost = exports.unlike = exports.search = exports.retweeters = exports.retweet = exports.post = exports.likers = exports.like = exports.details = void 0;
    ...
    return {
        ...
        data: {
            ...
            variables: {
                ...
                dark_request: false,
                attachment_url: args.quote ? "https://twitter.com/i/status/".concat(args.quote) : undefined,
